...
# print(f"PAYPAL_CLIENT_ID: {RAZORPAY_KEY_SECRET}")
...
PAYPAL_CURRENCY = os.getenv('PAYPAL_CURRENCY', 'EUR')  # Default to EUR
# Print the PayPal client ID for debugging purposes
